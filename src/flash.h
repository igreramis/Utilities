...
//working on the theory that the freertos takes up space uptil 292 pages, lets try page
...
#define FLASH_USER_START_ADDR       ADDR_FLASH_PAGE_33   /* Start @ of user Flash area */
#define FLASH_USER_END_ADDR         ADDR_FLASH_PAGE_34//ADDR_FLASH_PAGE_36   /* End @ of user Flash area */
#define FLASH_PAGE_TO_BE_PROTECTED (OB_WRP1_PAGES288TO303|OB_WRP1_PAGES304TO319)//(OB_WRP1_PAGES32TO47 | OB_WRP1_PAGES48TO63)
